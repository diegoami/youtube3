...
| F-4 | "make a landing page with liked" | in review | Proposal #29. A static page built from F-3's export: thumbnails, titles, channels, dates, search. Where it is hosted is an open question. Depends on F-3. |

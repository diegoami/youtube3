...
- **the gates table:**
  ...
  | G3b page logic | `node --test "tests/page/*.test.cjs"` (Node 24) | the landing page's search, channel filter, sorts and counts in `youtube3/page_assets/page.js` | every PR touching the page, CI | 1 | deterministic, offline |
